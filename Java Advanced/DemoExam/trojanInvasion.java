...
public class trojanInvasion {
    public static void main(String[] args) {
        ...
        int waves = Integer.parseInt(in.nextLine());

        ArrayDeque<Integer> defenders = Arrays.stream(in.nextLine().split("\\s+"))
        ...
        for (int i = 1; i <= waves && !defenders.isEmpty(); i++) {
            ...
            if (i % 3 == 0) {
                int additionalDefender = Integer.parseInt(in.nextLine());
