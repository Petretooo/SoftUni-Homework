...
public class SoftParkTest {
    ...
    public void testValidImplementationConstructor(){
        ...
        int actualPartCount = park.getParking().size();
    ...
    public void testParkCarMethodShouldThrowExceptionWhenParkSpotNotExist(){
        SoftPark park = new SoftPark();
        Car car = new Car("Audi", "CA 1234 CA");
        park.parkCar("W1",car);
    }
    ...
    public void testRemoveCarMethodShouldThrowException(){
        SoftPark park = new SoftPark();
        Car car = new Car("Audi", "CA 1390 CA");
        Car car1 = new Car("BMW", "AA 1390 CA");
        park.parkCar("A1", car);
        park.removeCar("A1", car1);
    }

    @Test
    public void testRemoveCarMethodShouldCorrectlyRemoveCarFromCollection(){
        SoftPark park = new SoftPark();
        Car car = new Car("Audi", "CA 1390 CA");
        park.parkCar("A1", car);
