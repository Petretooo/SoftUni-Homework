package AbstractionsEnumerationsStatic.jediGalaxy;
...
public class Main {
    public static void main(String[] args) {
        ...
        int[] dimentions = readIntegerArray(scanner.nextLine());

        Galactic galactic = new Galactic(dimentions[0], dimentions[1]);
        ...
        while (!command.equals("Let the Force be with you")) {
            ...
            int starsToAdd = cluster.collectPlayerStars(playerRow, playerCol, player);
