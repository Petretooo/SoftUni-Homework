package InterfacesAndAbstractions.army;
...
import InterfacesAndAbstractions.army.army.soldiers.*;
            ...
            try {
                ...
                switch (soldierType) {
                    ...
                    case "LeutenantGeneral":
                        ...
                        soldier = new LieutenantGeneralImpl(id, firstName, lastName, salary, extractedData);
                        break;
                    case "Commando":
                        corps = lineData[5];
                        startIndex = 5;
