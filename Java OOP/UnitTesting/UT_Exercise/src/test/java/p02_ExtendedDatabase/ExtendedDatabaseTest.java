...
public class ExtendedDatabaseTest {
    ...
    @Test(expected = OperationNotSupportedException.class)
    public void findByUsernameShouldThrowAnExceptionWithDuplicateUsername() throws OperationNotSupportedException {
    ...
    @Test
    public void findByUsernameShouldBeCaseSensititve() throws OperationNotSupportedException {
